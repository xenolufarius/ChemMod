...
public class DeconstructorBlockMenu extends AbstractContainerMenu {
    public final DeconstructorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public DeconstructorBlockMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        //Maybe 2
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DECONSTRUCTOR_BLOCK.get());
    }
