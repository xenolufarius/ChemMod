...
public class ReconstructorBlockScreen extends AbstractContainerScreen<ReconstructorBlockMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ChemMod.MOD_ID,"textures/gui/deconstructor_prototype2_gui.png");

    public ReconstructorBlockScreen(ReconstructorBlockMenu menu, Inventory inventory, Component component) {
